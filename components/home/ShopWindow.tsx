...
const tabs = [
  { id: "all", label: "All" },
  { id: "slices", label: "Fruit Slices" },
  { id: "powder", label: "Banana Powder" },
  { id: "top", label: "Best Sellers" },
] as const;

type TabId = (typeof tabs)[number]["id"];

const fruitFilters: (FruitType | "All")[] = ["All", ...FRUIT_TYPES];
...
function selectProducts(tab: TabId, fruit: FruitType | "All"): Product[] {
  let list = products;
  if (tab === "slices") list = list.filter((p) => p.category === "Dehydrated Fruit");
  if (tab === "powder") list = list.filter((p) => p.category === "Fruit Powder");
...
export default function ShopWindow() {
  ...
  return (
    <motion.div
      ...
      className="rounded-[1.75rem] bg-white border border-forest/10 shadow-window overflow-hidden"
    >
      {/* chrome */}
            ...
            >
                      ...
                      <div className="p-3">
                        ...
                        <div className="flex items-center gap-1 mt-0.5 mb-2">
                          ...
                          <span className="text-[11px] text-forest-deep/50">
                            {product.rating.toFixed(1)} &middot; {variant.weight}
                          </span>
                        </div>
              ...
              {Array.from({ length: GRID_SLOTS - visible.length }).map((_, i) => (
                ...
                >
                  ...
                  <div className="p-3">
                    <p className="text-xs sm:text-sm font-semibold truncate">&nbsp;</p>
                    <div className="flex items-center gap-1 mt-0.5 mb-2">
                      <Star size={10} />
