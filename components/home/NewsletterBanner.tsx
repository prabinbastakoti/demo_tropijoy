          ...
          <div className="rounded-[2rem] border border-forest/10 bg-white px-6 py-12 sm:px-14 sm:py-16 text-center">
            ...
            >
              ...
              <button
                type="submit"
                disabled={loading}
                className="shrink-0 inline-flex items-center justify-center gap-2 rounded-full bg-sunny text-forest-deep text-sm font-semibold px-6 py-3 hover:bg-sunny-bright transition-colors disabled:opacity-50"
              >
